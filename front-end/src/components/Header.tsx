    ...
    <header className="navbar bg-tertiary shadow-sm px-6 text-white relative">
      ...
      <div className="navbar-center hidden md:flex">
        <nav className="flex items-center gap-6">
          ...
          <NavLink to="/toolsManagement" className="whitespace-nowrap" aria-label="Go to Tools Management">
            Tools Management
          </NavLink>
          <NavLink to="/materials" className="whitespace-nowrap" aria-label="Go to Materials Management">
            Materials Management
          </NavLink>
          <NavLink to="/projects" className="whitespace-nowrap" aria-label="Go to Project Management">
            Project Management
          </NavLink>
        </nav>
      </div>
