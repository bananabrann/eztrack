...
//       <div className="navbar-center hidden md:flex">
//         <nav className="flex items-center gap-6">
//           <NavLink to="/" className="whitespace-nowrap" aria-label="Go to Home Page">Home</NavLink>
//           <NavLink to="/toolsManagement" className="whitespace-nowrap" aria-label="Go to Tools Management">Tools Management</NavLink>
//           <NavLink to="/materials" className="whitespace-nowrap" aria-label="Go to Materials Management">Materials Management</NavLink>
//           <NavLink to="/projects" className="whitespace-nowrap" aria-label="Go to Project Management">Project Management</NavLink>
//         </nav>
//       </div>
...
//           <NavLink to="/toolsManagement" onClick={() => setMenuOpen(false)}>Tools Management</NavLink>
//           <NavLink to="/materials" onClick={() => setMenuOpen(false)}>Materials Management</NavLink>
//           <NavLink to="/projects" onClick={() => setMenuOpen(false)}>Project Management</NavLink>
//         </nav>
//       </div>
//     </header>
//   );
